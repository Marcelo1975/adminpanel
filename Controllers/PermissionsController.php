...
class PermissionsController extends Controller {
    ...
    public function items_add() {
        ...
        $this->loadTemplate('items_add', $this->arrayInfo);    
    }

    public function items_add_action_permission() {
        $p = new Permissions();
        if(!empty($_POST['name'])) {
            $name = $_POST['name'];
            $slug = str_replace(' ', '_', $name);
            $id = $p->addPermissionItem($name, $slug);
    ...
    public function items_edit($id) {
        if(!empty($id)) {
            ...
            $this->arrayInfo['permissions_id'] = $id;
            ...
            $this->loadTemplate('items_permissions_edit', $this->arrayInfo);
        } else {
    ...
    public function items_del($id_item) {
        ...
        $p->delPermissionItem($id_item);
        $p->delPermissionItemLink($id_item);
    ...
    public function edit($id) {
        if(!empty($id)) {
            ...
            $this->arrayInfo['permission_items'] = $p->getAllItems();
            $this->arrayInfo['permissions_id'] = $id;
            $this->arrayInfo['permission_group_name'] = $p->getPermissionsGroupName($id);
