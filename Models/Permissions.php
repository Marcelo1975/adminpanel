...
class Permissions extends Model {
    ...
    public function getPermissionsGroupName($id_permission) {
    ...
    public function itemsEditName($name, $id) {
    ...
    public function delPermissionItem($id) {
    ...
    public function delPermissionItemLink($id) {
